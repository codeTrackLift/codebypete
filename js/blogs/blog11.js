...
const blog11Body = `
    <div class="accordion-body">
        ...
        <div class="row">
            <p ${blog11pStyle}>
               This is my recap of my last <span class='text-white'>3 weeks</span> as a <span class='text-white'>43 year old Software Engineering Intern</span>...
            </p>
        </div>
        <div class="row">
            ...
            <ol ${blog11olStyle}>
                ...
                <li><span class='text-white'>Developed</span>, <span class='text-white'>merged</span>, and closed 3 Jira Tickets and PRs</li>
        ...
        <div class="row">
            ...
            <p ${blog11pStyle}>
                It all became very real when I got my laptop (16" MacBook Pro) and monitor delivered and set up.  Getting local admin on the laptop was the first challenge, this took almost 2 working days, but was well worth the effort!  After getting privileges to execute '<a href='https://www.sudo.ws/' target='_blank'>sudo</a>' commands, I started feeling like a developer again!  This feeling did not last long as I immediately slipped back into <span class='cornflowerBlue'>imposter syndrome</span> when I couldn't get my first '<span class='text-white'>npm install</span>' to run.  
            </p>
            <p ${blog11pStyle}>
            ...
            <p ${blog11pStyle}>
                After making the button and verifying that it looks and functions as intended in my local development environment, I had to push it to the GitHub repository and make a pull request.  <span class='cornflowerBlue'>Imposter syndrome</span> was kicking in hard at this point, as I was about to expose my coding insecurities to the whole world (or so it felt)!  I reached out to a junior developer on the team and shared my files with him, hoping for some reassurance.  He gave me the thumbs up, then encouraged me to push the code, and so I did.
            </p>
            <p ${blog11pStyle}>
                Folks had warned me that your first PR as a developer could result in a lot of comments.  <span class='text-white'>55 comments</span> later, my ButtonWithImages could now be dynamically rendered with different SVGs, text, onClick functionality, and even included a suite of <a href='https://jestjs.io/' target='_blank'>Jest</a> unit tests!  Each comment pointed out weaknesses in my code, like redundant and inefficient code, as well as failure to have good test coverage.
            </p>
            <p ${blog11pStyle}>
                This set a good back and forth tempo with the experienced software engineers on the team.  I could share my attempts at a solution, then see how a master would do it.  By the end of the third week, I had the opportunity to work on 6 <a href='https://www.reactjs.org' target='_blank'>React</a> tickets and 3 of them were approved, merged, and closed.  One of the tickets was to investigate an unintended issue; we have a follow-up meeting next week to discuss the investigation findings and determine a path forward.
            </p>
            <p ${blog11pStyle}>
                My first three weeks with Forbes validates my decision to leave my cushy pharmaceutical job to pursue my passion.  <span class='text-white'>I enjoy every minute of the work</span>, learning each new technology feels exciting and rewarding, and the team is warm and welcoming.  Maybe this will change if I ever lose the 'intern' status; however, I will not worry right now as I only have 5 short weeks left with this team.
            </p>
            <p ${blog11pStyle}>
        ...
        <div class="row">
            <div class="my-auto text-end">
                ...
                <p style="text-align:end;font-style:italic;color:white;">Jun 26, 2022</p>
            </div>
        </div>
    </div>    
`;
