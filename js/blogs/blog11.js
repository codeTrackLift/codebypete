...
const blog11Body = `
    <div class="accordion-body">
        ...
        <div class="row">
            <p ${blog11pStyle}>
                I never thought I would be so excited to go to work! This is my review of <span class='text-white'>3 weeks as a 43 year old Software Engineering Intern</span>...
            </p>
        </div>
        <div class="row">

            <span class='menloRegular chocolate'>TLDR:</span>
            <hr>
            <ol ${blog11olStyle}>
        ...
        <div class="row">
            <p ${blog11pStyle}>
                It has now been three weeks since I started my full-time paid internship at <a href='https://www.forbes.com' target='_blank'>Forbes Media</a> as part of their Frontend Engineering team. During the second trimester of bootcamp, the career coaches at MIT xPRO hooked me up with a referral for the <a href='https://www.linkedin.com/posts/codebypete_webdevelopment-mernstackdeveloper-activity-6931971649504198656-hdBr?utm_source=linkedin_share&utm_medium=member_desktop_web' target='_blank'>Engineering Internship</a>.  I wasn't expecting to get called for the interview, but was pleasantly surprised when it happened.  
            </p>
            <p ${blog11pStyle}>
            ...
            <p ${blog11pStyle}>
                It all became very real when I got my laptop (16" MacBook Pro) and monitor delivered and set up.  Getting local admin on the laptop was the first challenge, this took almost 2 working days, but was well worth the effort!  After getting privileges to execute '<a href='https://www.sudo.ws/' target='_blank'>sudo</a>' commands, I started feeling like a developer again!  This feeling did not last long as I immediately slipped back into imposter syndrome when I couldn't get my first 'npm install' to run.  
            </p>
            <p ${blog11pStyle}>
            ...
            <a class="btn btn-secondary btnDark mx-auto my-3" style='opacity:1 !important' target="'_blank"><img src="../pics/contact/GitHub-Mark-64px.png"> Readme</a>
            <p ${blog11pStyle}>
