...
const blog12Body = `
    <div class="accordion-body">
        ...
        <div class="row">
            ...
            <p style='margin: 0.5rem auto;'>
                Everything starts out fine.  You learn to define variables and do some arithmetic; it's kinda fun! That all changes once you dove into array methods and objects... ever heard of the phrase '<a href='https://en.wikipedia.org/wiki/Haemolacria' target='_blank'>making your eyes bleed</a>’?  😢
            </p>
            <p style='margin: 0.5rem auto;'>
