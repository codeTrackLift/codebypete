const cBPCard = `
    <div id='cBPCard' class="card col-sm-4" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Includes a <span class='text-white'>mobile first</span> and <span class='text-white'>responsive design</span> with custom JavaScript functionality and CSS animations, see <a href="../pages/blog.html#blog4Button">blog[4]</a>.</p>
