const xChangeMernCard = `
    <div id='xChangeMernCard' class="card col-sm-4" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text">The demo is deployed on <span className='text-white'>Heroku</span> (please give it a min to spin up), see <a href="../pages/blog.html#blog9Button">blog[9]</a>.</p>
