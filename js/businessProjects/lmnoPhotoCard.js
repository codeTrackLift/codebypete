const lmnoPhotoCard = `
    <div id='lmnoPhotoCard' class="card col-sm-4" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><a href="https://www.lmnophoto.biz" target="_blank">LMNOPhoto.biz</a> was my
                <span>first
                    freelance project</span> and was completed using <a
                    href="https://getbootstrap.com/docs/5.1/getting-started/introduction/"
                    target="_blank">Bootstrap</a> and <a href="https://scrollmagic.io/"
                    target="_blank">ScrollMagic</a>.</p>
            <p class="card-text">Need a photography session in the Philadelphia / King of Prussia area?</p>
            <a id='lmnoPhotoDemo' href="https://www.lmnophoto.biz/" class="mx-auto btn btn-secondary"
