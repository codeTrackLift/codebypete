const xChangeMernCard = `
    <div id='xChangeMernCard' class="card col-sm-4" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><a href='#xChangeCard'>BadBank</a> was upgraded into a full stack MERN app using <span className='text-white'>MongoDB</span>, <span className='text-white'>Mongoose</span>, <span className='text-white'>Express</span>, <span className='text-white'>React</span>, and <span className='text-white'>Redux</span>.</p>
