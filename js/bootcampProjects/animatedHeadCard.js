const animatedHeadCard = `
    <div id='animatedHeadCard' class="card col-sm-4" style="width: 18rem;">
        <img src="../pics/projects/animatedHead.gif" class="card-img-top mx-auto pt-4" alt="Animated head image"
            style="width:10rem;">
        <div class="card-body">
            <h5 class="card-title">Eye Movement</h5>
            <p class="card-text">This <a href="https://xpro.mit.edu/" target="_blank">MIT xPRO</a> <span>
                    Bootcamp Project</span> demonstrates use of 'onmouse' and 'ontouch' event handlers.</p>
            <p class="card-text"><span>Custom CSS</span> 'aesthetics' and 'typewriter' text was added, see <a
                    href="../pages/blog.html#blog5Button">blog[5]</a>.</p>
            <div class="btnContainer">
                <a id='animatedHeadDemo' href="https://codetracklift.github.io/eyemovement/"
                    class="btn btn-secondary" target="_blank">Try Demo</a>
                <a id='animatedHeadRepo' href="https://github.com/codeTrackLift/eyemovement#readme"
