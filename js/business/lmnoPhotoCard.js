const lmnoPhotoCard = `
    <div id='lmnoPhotoCard' class="card col-sm-4" style="width: 18rem;">
        ...
        <div class="card-body">
            <h5 class="card-title">lmnophoto.biz</h5>
            <p class="card-text">This landingpage was my <span>first freelance project</span> and was completed using <a href="https://getbootstrap.com/docs/5.1/getting-started/introduction/" target="_blank">Bootstrap</a> and <a href="https://scrollmagic.io/" target="_blank">ScrollMagic</a>.</p>
